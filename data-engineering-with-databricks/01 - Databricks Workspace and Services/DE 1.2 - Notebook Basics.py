...
# MAGIC %fs ls file:/dbfs/mnt/dbacademy-datasets/data-engineering-with-databricks/v02/flights

# COMMAND ----------

# MAGIC %sh ls /dbfs/mnt/dbacademy-datasets/data-engineering-with-databricks/v02/flights

# COMMAND ----------

import os

os.listdir('/dbfs/mnt/dbacademy-datasets/data-engineering-with-databricks/v02/flights')
...
dbutils.widgets.text("Name", "Deeksha")

# COMMAND ----------

dbutils.widgets.dropdown("Color","B", ["R", "G", "B"])
...
## Spark API format
display(dbutils.fs.ls ("/mnt/dbacademy-datasets/data-engineering-with-databricks/v02/flights/departuredelays.csv"))
